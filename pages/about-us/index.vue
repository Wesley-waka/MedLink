<template>
  <div>
      ...
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <div :class="{'block': isMenuOpen, 'hidden': !isMenuOpen}" class="w-full md:flex md:w-auto">
          <div class="flex flex-col md:flex-row md:space-x-4 mt-4 md:mt-0">
            ...
            <a href="/about-us" class="block px-4 py-2 text-white hover:text-gray-400">About</a>
    ...
    <div class="flex flex-col">
      <div class="flex flex-row  px-[20px] space-x-16">
      <img src="/about-1.jpg" class="h-[600px] w-[1200px] object-cover" style="width: 180%" alt="">
      <div class="flex-col space-y-8 my-14">
      <div class="leading-[80px] text-[90px] font-medium text-black">A Dentistry clinic <br> you can trust</div>
      <p class="text-[17px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
        <div class="flex space-x-12">
          <div class="flex-col space-y-1 text-center"><p class="text-5xl font-bold">140+</p> <p class="text-2xl">Doctors</p></div>
          <div class= "flex-col space-y-1 text-center"><p class="text-5xl font-bold">140+</p> <p class="text-2xl">Doctors</p></div>
          <div class="flex-col space-y-1 text-center"><p class="text-5xl font-bold">140+</p> <p class="text-2xl">Doctors</p></div>
        </div>
      </div>
    ...
    <div class="px-[20px] my-[50px]">
    <div class="flex-col space-y-3">
      <h1 class="font-semibold text-[50px] leading-[55px]">The Best & <br> Right Dental Service</h1>
      <p class="w-[800px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</p>
    </div>
      <div class="flex flex-row my-6 space-x-12">
        <div class="flex-col w-[400px] space-y-4">
        <img src="/medi-1.svg" alt="" class='p-8 bg-amber-400' srcset="">
        <h1 class="font-semibold text-[18px]">Dental Implants</h1>
        <p>Metrics validation,Lorem ipsum dolor sit amet, consectetur adipiscing elit,Lorem ipsum dolor sit amet, consectetur adipiscing elit,Lorem ipsum dolor sit amet, consectetur adipiscing elit,</p>
      </div>
    ...
    <div class="flex flex-row space-x-4 px-[20px]">
      <div><h1 class="font-semibold text-[40px] leading-[48px]">Make an Appointment With a Doctor<br> To Find A Solution <br>To Your Problem  </h1>
      <p class="w-[700px]">Metrics validation,Lorem ipsum dolor sit amet, consectetur adipiscing elit,Lorem ipsum dolor sit amet, consectetur adipiscing elit,Lorem ipsum dolor sit amet, consectetur adipiscing elit,</p>
      </div>
      <img src="/about-2.jpg" class="h-[400px] w-[1200px] object-cover" style="width: 180%" alt="">
    ...
    <div>
      ...
      <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <blockquote class="text-center lg:mx-auto lg:w-3/5">
          <svg class="mx-auto w-20 h-auto sm:w-28 text-gray-800 dark:text-neutral-600" width="106" height="36" viewBox="0 0 106 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="mt-6 lg:mt-10">
            <p class="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
              ...
              <span class="relative z-10 italic text-gray-800 dark:text-neutral-800">I just wanted to say that I'm very happy with my purchase of Preline so far. The documentation is outstanding - clear and detailed.</span>
            </p>
          </div>
